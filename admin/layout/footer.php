...
<!-- Bootstrap 4 -->
<script src="<?= base_url ?>admin/layout/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- InputMask -->
<script src="<?= base_url ?>admin/layout/plugins/moment/moment.min.js"></script>
<!-- date-range-picker -->
<script src="<?= base_url ?>admin/layout/plugins/daterangepicker/daterangepicker.js"></script>
...
<script src="<?= base_url ?>admin/layout/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="<?= base_url ?>admin/layout/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
</body>
